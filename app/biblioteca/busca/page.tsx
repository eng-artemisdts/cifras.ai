...
export const metadata: Metadata = {
  title: "Busca · Biblioteca · cifra.ai",
  description: "Resultados da pesquisa na sua biblioteca.",
};

export default async function BibliotecaBuscaPage() {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-cifra-bg text-cifra-text">
      <LibraryTopNav
        items={libraryNavForPath("/biblioteca/busca")}
        user={user}
      ...
      <main className="relative flex flex-1 flex-col items-center overflow-hidden">
        ...
        <div className="relative z-10 w-full flex-1">
          ...
          >
            <LibrarySearchResultsBody routeBasePath="/biblioteca/busca" backHref="/biblioteca" />
          </Suspense>
        </div>
      </main>
      <LibraryPageFooter />
